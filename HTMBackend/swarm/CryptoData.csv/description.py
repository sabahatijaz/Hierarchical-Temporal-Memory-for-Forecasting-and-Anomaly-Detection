...
'/home/odyssey/Downloads/HTMWrapper/venv/lib/python2.7/site-packages/nupic/swarming/exp_generator/experiment_generator.pyc'
"""
...
config = {
    ...
    'modelParams': {
        ...
        'sensorParams': {
            ...
            #
            'encoders': {
                u'Date_timeOfDay':     {   'fieldname': u'Date',
    'name': u'Date_timeOfDay',
    'timeOfDay': (21, 1),
    'type': 'DateEncoder'},
  u'Date_dayOfWeek':     {   'dayOfWeek': (21, 1),
    'fieldname': u'Date',
    'name': u'Date_dayOfWeek',
    'type': 'DateEncoder'},
  u'Date_weekend':     {   'fieldname': u'Date',
    'name': u'Date_weekend',
    'type': 'DateEncoder',
    'weekend': 21},
...
control = {
  ...
  #
  'dataset' : {   u'info': u'value',
        u'streams': [   {   u'columns': [u'*'],
                            u'info': u'Rec Center',
                            u'source': u'file://Data/CryptoData.csv/CryptoData.csv.csv'}],
        u'version': 1},
 ...
 u'predictionSteps': [1, 2]},

  # Metrics: A list of MetricSpecs that instantiate the metrics that are
  # computed for this experiment
  'metrics':[
    MetricSpec(field=u'value', metric='multiStep', inferenceElement='multiStepBestPredictions', params={'window': 1000, 'steps': [1, 2], 'errorMetric': 'aae'}),
    MetricSpec(field=u'value', metric='multiStep', inferenceElement='multiStepBestPredictions', params={'window': 1000, 'steps': [1, 2], 'errorMetric': 'altMAPE'})
  ],
