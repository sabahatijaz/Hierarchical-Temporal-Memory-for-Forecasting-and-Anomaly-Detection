...
config ={
  ...
  'modelParams' : {'tmParams': {'minThreshold': 9, 'activationThreshold': 12, 'pamLength': 1}, 'sensorParams': {'encoders': {u'Date_dayOfWeek': {'dayOfWeek': (21, 1), 'name': 'Date', 'fieldname': 'Date', 'type': 'DateEncoder'}, u'Date_weekend': None, u'Date_timeOfDay': None, u'value': {'name': 'value', 'clipInput': True, 'n': 311, 'fieldname': 'value', 'w': 21, 'type': 'AdaptiveScalarEncoder'}}}, 'spParams': {'synPermInactiveDec': 0.1}, 'clParams': {'alpha': 0.0001}},
