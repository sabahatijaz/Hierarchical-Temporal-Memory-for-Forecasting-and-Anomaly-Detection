...
control = {
  ...
  'dataset' : {   u'info': u'value',
        u'streams': [   {   u'columns': [u'*'],
                            u'info': u'Rec Center',
                            u'source': u'file://Data/CryptoData/CryptoData.csv'}],
        u'version': 1},
 ...
 u'predictionSteps': [1, 0]},

  # Metrics: A list of MetricSpecs that instantiate the metrics that are
  # computed for this experiment
  'metrics':[
    MetricSpec(field=u'value', metric='multiStep', inferenceElement='multiStepBestPredictions', params={'window': 1000, 'steps': [1, 0], 'errorMetric': 'aae'}),
    MetricSpec(field=u'value', metric='multiStep', inferenceElement='multiStepBestPredictions', params={'window': 1000, 'steps': [1, 0], 'errorMetric': 'altMAPE'})
  ],
